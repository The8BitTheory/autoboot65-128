...
# C64 LOAD WITH HYPRA-LOAD
# MAX LOADABLE SIZE: REGULAR LOADING
# ONLY WORKS ON 1541,1570,1571. NOT ON 1581
...
340 DATA A9,01,85,C6
350 DATA 4C,74,A4
360 DATA 0D,4C,4F,41,44,22,-2
370 DATA 0D,0D,0D,0D,0D,20,20,20,91,91,91,91,91,91,91,0,-1